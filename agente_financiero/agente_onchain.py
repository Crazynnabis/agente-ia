...
def obtener_datos_blockchain_btc() -> dict:
    try:
        ...
        return {
            ...
            "txs_mempool":     bloques[0].get("tx_count", 0) if bloques else 0,
...
def obtener_datos_eth() -> dict:
    try:
        ...
        try:
            r2 = requests.get("https://api.binance.com/api/v3/ticker/price?symbol=ETHUSDT", timeout=10)
            return {"precio_eth": float(r2.json()["price"]), "gas_lento": "N/A", "gas_medio": "N/A", "gas_rapido": "N/A"}
        except:
